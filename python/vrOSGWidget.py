...
def getSceneIntersection(rayOrigin, index, rayDirection):
    '''
...
def getSceneIntersection(xCoord, index, yCoord):
    '''
...
def getUserCameraMatrix(userId, cameraName):
    '''
...
def getUserCameraMatrix(userId, windowId):
    '''
    Gets the user projection camera world matrix (column-wise).
    '''
    pass
...
def enableStereo(window, zp, mode, state, es, passive):
    '''
    Enables stereo.
    '''
    pass
...
def getViewRay(xCoord, index, yCoord):
    '''
...
def moveRenderWindow(yPos, index, xPos):
    '''
...
def setCameraConstraint(min_dist, camera_constraint):
    '''
...
def setFromAtUp(index, fy, fz, ax, az, ux, fx, uy, from_, up, uz, ay, at):
    '''
...
def setFrustum(index, bottom, left, right, top):
    '''
    Set camera frustum
    '''
    pass
...
def setGradientBackground(ints, index, colors):
    '''
...
def setPivot(point, index, y, x, z):
    '''
...
def setRenderRegion(startY, startX, endX, endY, on):
    '''
...
def setRenderWindowDocked(flags, index, state):
    '''
...
def showBanner(width, t, height, text, bcolor):
    '''
