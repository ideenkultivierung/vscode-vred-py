...
def captureVariantSetFromRootNodes(inclRenderlayerStates, inclLights, inclEnvs, name, inclView, inclNodes, roots, sendMsg, inclMaterials):
    '''
...
def dissectionSnapshot(height, filename, ssf, width):
    '''
