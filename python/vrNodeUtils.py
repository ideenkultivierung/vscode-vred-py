...
def createBox(red, res_z, green, res_y, blue, res_x, alpha, size_z, size_x, size_y):
    '''
...
def createCone(create_side, red, radius, green, blue, height, create_bottom, sides):
    '''
...
def createCylinder(create_side, red, radius, create_top, green, blue, height, create_bottom, sides):
    '''
...
def createEnvBox(red, res_z, green, transparency, res_y, blue, res_x, texture, size):
    '''
...
def createLatLongSphere(red, radius, green, blue, longres, latres):
    '''
...
def createLine(red, bx, green, az, blue, bz, ax, ay, by):
    '''
...
def createPlane(red, green, res_y, blue, res_x, size_x, size_y):
    '''
...
def createSphere(resolution, red, radius, green, blue):
    '''
...
def setTransformNodeRotatePivot(z, node, x, y, worldSpace):
    '''
...
def setTransformNodeRotatePivotTranslation(z, node, y, x):
    '''
...
def setTransformNodeRotation(z, node, y, x):
    '''
...
def setTransformNodeRotationOrientation(z, node, y, x):
    '''
...
def setTransformNodeScale(z, node, y, x):
    '''
...
def setTransformNodeScalePivot(z, node, x, y, worldSpace):
    '''
...
def setTransformNodeScalePivotTranslation(z, node, y, x):
    '''
...
def setTransformNodeShear(node, xz, yz, xy):
    '''
...
def setTransformNodeTranslation(z, node, x, y, worldSpace):
    '''
