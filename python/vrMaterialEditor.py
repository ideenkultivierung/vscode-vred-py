...
def applyEnvToAllMaterials(mat_name, mat):
    '''
    Applies an environment material to all materials.
    '''
    pass
...
def applySubstancePresetByName(name, mat):
    '''
    Applies an existing substance preset to the given substance material.
    '''
    pass
...
def applySubstancePresetWithDefaultOutputSizeByName(name, mat):
    '''
    Applies an existing substance preset with default output size to the given substance material.
    '''
    pass
...
def loadSubstanceArchive(archiveFilePath, mat):
    '''
...
def loadSubstancePresets(presetsFilePath, mat):
    '''
...
def setMaterialAmbientColor(value, hue, saturation, index):
    '''
...
def setMaterialDiffuseColor(value, hue, saturation, index):
    '''
...
def setMeasuredCarpaintGlossyAsDiffuseLobes(lobes, mat):
    '''
