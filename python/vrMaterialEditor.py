...
def loadMeasurement(measurementFilePath, mat):
    '''
...
def setMaterialAmbientColor(hue, saturation, index, value):
    '''
...
def setMaterialDiffuseColor(hue, saturation, index, value):
    '''
