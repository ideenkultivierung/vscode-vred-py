...
def setRaytracingAAImageFilter(height, width, id):
    '''
...
def setRaytracingRenderRegion(yBegin, xEnd, yEnd, xBegin):
    '''
...
def setRenderBackgroundColor(g, b, r):
    '''
...
def setRenderPixelResolution(pixelsPerInch, pixelWidth, pixelHeight):
    '''
...
def setRenderPrintResolution(pixelsPerInch, printHeight, printWidth):
    '''
    Sets the print resolution.
    '''
    pass
